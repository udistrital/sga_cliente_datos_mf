...
import { ActualizacionDatos } from '../../models/solicitudes/actualizacion-datos'
import { RespuestaSolicitud } from '../../models/solicitudes/respuesta-solicitud';
import { Solicitante } from '../../models/solicitudes/solicitante';
...
@Component({
  selector: 'sga-datos-mf-actualizacion-datos',
  standalone: true,
  imports: [
    MatCardModule,
  ...
  styleUrl: './actualizacion-datos.component.scss'
})
