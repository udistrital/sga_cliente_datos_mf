...
@Component({
  selector: 'sga-datos-mf-actualizacion-nombres',
  standalone: true,
  imports: [MatCardModule, DatosSolicitanteComponent, DynamicFormComponent],
  templateUrl: './actualizacion-nombres.component.html',
  styleUrl: './actualizacion-nombres.component.scss',
})
export class ActualizacionNombresComponent implements OnInit {
  ...
  //     this.sgaMidService
  //       .get('persona/consultar_info_solicitante/' + IdTercero)
  ...
  //     this.sgaMidService
  //       .get(
  //         'solicitud_evaluacion/consultar_solicitud/solicitud/' + IdSolicitud
  //       )
  //       .subscribe(
  //         (response: any) => {
  ...
  //             const date = moment(
  //               response.Response.Body[0].FechaExpedicionNuevo,
  //               'DD/MM/YYYY'
  //             ).toDate();
  //             this.solicitudForm.campos[
  //               this.getIndexForm('FechaSolicitud')
  //             ].valor = momentTimezone
  //               .tz(response.Response.Body[0].FechaSolicitud, 'America/Bogota')
  //               .format('DD/MM/YYYY');
  //             this.solicitudForm.campos[
  //               this.getIndexForm('NombreActual')
  //             ].valor = response.Response.Body[0].NombreActual;
  //             this.solicitudForm.campos[
  //               this.getIndexForm('NombreActual')
  //             ].deshabilitar = true;
  //             this.solicitudForm.campos[
  //               this.getIndexForm('ApellidoActual')
  //             ].valor = response.Response.Body[0].ApellidoActual;
  //             this.solicitudForm.campos[
  //               this.getIndexForm('ApellidoActual')
  //             ].deshabilitar = true;
  //             this.solicitudForm.campos[
  //               this.getIndexForm('NombreNuevo')
  //             ].valor = response.Response.Body[0].NombreNuevo;
  //             this.solicitudForm.campos[
  //               this.getIndexForm('NombreNuevo')
  //             ].deshabilitar = true;
  //             this.solicitudForm.campos[
  //               this.getIndexForm('ApellidoNuevo')
  //             ].valor = response.Response.Body[0].ApellidoNuevo;
  //             this.solicitudForm.campos[
  //               this.getIndexForm('ApellidoNuevo')
  //             ].deshabilitar = true;
  //             this.solicitudForm.Documento =
  //               response.Response.Body[0].Documento;
  //             const files = [];
  ...
  //     this.respuestaSolicitudForm.campos[1].valor;
  //   this.sgaMidService
  //     .post('solicitud_evaluacion/registrar_evolucion', this.solicitudRespuesta)
  //     .subscribe(
  //       (response: any) => {
  //         if (response.Response.Code === '200') {
  //           this.loading = false;
  ...
  //   this.sgaMidService
  //     .get('solicitud_evaluacion/consultar_solicitud/solicitud/' + IdSolcitud)
  //     .subscribe(
  //       (response: any) => {
  //         if (response.Response.Code === '200') {
  //           this.solicitudForm.campos[this.getIndexForm('NombreNuevo')].valor =
  //             response.Response.Body[0].NombreNuevo;
  //           this.solicitudForm.campos[
  //             this.getIndexForm('NombreNuevo')
  //           ].deshabilitar = true;
  //           this.solicitudForm.campos[
  ...
  //           this.sgaMidService
  //             .get(
  //               'solicitud_evaluacion/consultar_solicitud/' + IdSolcitud + '/18'
  //             )
  //             .subscribe(
  //               (response: any) => {
  //                 if (response.Response.Code === '200') {
  ...
  //               }
  //               this.sgaMidService
  //                 .post('solicitud_evaluacion/registrar_solicitud', Solicitud)
  //                 .subscribe(
  //                   (res: any) => {
